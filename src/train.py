...
if __name__ == '__main__':
    ...
    for epoch in range(MAX_EPOCH):
        ...
        # train
        loss_train, acc_train = ModelTrainer.train(train_loader, emg_model, main_criterion, main_optimizer, epoch, device, MAX_EPOCH)
        ...
        if acc_valid > best_acc:
            best_acc = acc_valid
            # torch.save(emg_model, 'trained/' + 'model_' + str(epoch) + '_' + str(round(best_acc, 4)) + '.pkl')
